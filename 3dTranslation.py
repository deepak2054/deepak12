...
zc=0
print("Enter translation factors tx, ty, tz")
...
for i in range(len(points)):
	pointsx.insert(i,translation(newpoints3d[i][0],newpoints3d[i][1],newpoints3d[i][2]))
print (pointsx)
drawcube(pointsx,'red')
window.create_text(points[1],text="cube after translation",font="Times 10 bold",fill='red')
